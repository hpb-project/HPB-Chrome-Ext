...
async function start() {
  ...
  const CHROME = `${BUILD_LINK_BASE}/builds/hpb-chrome-${VERSION}.zip`
  const FIREFOX = `${BUILD_LINK_BASE}/builds/hpb-firefox-${VERSION}.zip`
  const EDGE = `${BUILD_LINK_BASE}/builds/hpb-edge-${VERSION}.zip`
  const OPERA = `${BUILD_LINK_BASE}/builds/hpb-opera-${VERSION}.zip`
