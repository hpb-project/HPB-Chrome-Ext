...
export default class TokenInput extends PureComponent {
  ...
  //  log.info('TokenInput ==== handleChange',decimalValue  , selectedToken)
  //  alert('TokenInput ==== handleChange ' + decimalValue  + '| ' +  selectedToken);


   //var x = parseInt(decimalValue * 1000000000000000000) ;
  ...
  renderConversionComponent () {
    ...
    */
    ...
    console.log('renderConversionComponent === currentCurrency',selectedTokenExchangeRate, showFiat, currentCurrency)

   var x = parseInt(decimalEthValue * 1000000000000000000) ;
   const hexWeiValue = x.toString(16)
