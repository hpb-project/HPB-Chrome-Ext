...
describe('CurrencyInput Component', () => {
  describe('rendering', () => {
    ...
    it('should render properly with a suffix', () => {
      ...
      assert.equal(wrapper.find('.unit-input__suffix').text(), 'HPB')
      assert.equal(wrapper.find(CurrencyDisplay).length, 1)
    })

    it('should render properly with an HPB value', () => {
      const mockStore = {
        metamask: {
          nativeCurrency: 'HPB',
          currentCurrency: 'usd',
  ...
  describe('handling actions', () => {
    ...
    it('should call onChange and onBlur on input changes with the hex value for HPB', () => {
      const mockStore = {
        metamask: {
          nativeCurrency: 'HPB',
          currentCurrency: 'usd',
